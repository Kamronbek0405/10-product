...
export const Header = () => {
    return (
        <>
            ...
            <Link className="w-[90px] h-[40px] bg-slate-100 flex items-center justify-center shadow-md shadow-gray-400" to={'/'}>Home</Link>
            <Link className="w-[90px] h-[40px] bg-slate-100 flex items-center justify-center shadow-md shadow-gray-400" to={'/about'}>About</Link>
            <Link className="w-[90px] h-[40px] bg-slate-100 flex items-center justify-center shadow-md shadow-gray-400" to={'/shop'}>Shop</Link>
            <div className='flex '>
            <div className='w-[376px] h-[66px] rounded-full bg-slate-100 relative ml-10 '>
                <div className='w-[56px] h-[56px] bg-green-400 rounded-full flex items-center justify-center absolute right-2 mt-1'> 
            ...
            <div className='flex items-center ml-5 mr-10'>
                <div className='w-[56px] h-[56px] bg-slate-800 rounded-full flex items-center justify-center'>
                ...
                <span className='text-lg ml-5'>Card(0)</span>
            </div>
            </div>
        </>
    )
